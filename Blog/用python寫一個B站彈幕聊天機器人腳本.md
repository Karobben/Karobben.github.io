...
<a name="pt8sn"></a>
## 修改sample.py
把client ID改成要回覆彈幕的ID<br />![image.png](https://cdn.nlark.com/yuque/0/2020/png/691897/1584088741415-a52f9a6c-eaa4-4891-821f-b3e515321dda.png#align=left&display=inline&height=141&name=image.png&originHeight=141&originWidth=382&size=19868&status=done&style=none&width=382)
...
![image.png](https://cdn.nlark.com/yuque/0/2020/png/691897/1584201246930-db1cd345-0fff-4ba0-ba81-085b20cdecc0.png#align=left&display=inline&height=236&name=image.png&originHeight=236&originWidth=284&size=28687&status=done&style=none&width=284)<br />這樣所有人就可以, 通過命令, 自動
